  ...
  <cube-page type="tabs-basic-view" title="tab-basic">
    <div slot="content">
      <cube-tab-bar v-model="selectedLabel" show-slider>
        <cube-tab v-for="(item, index) in tabs" :index="index" :label="item.label" :icon="item.icon" :key="item.label">
        </cube-tab>
      </cube-tab-bar>
      <cube-tab-panels v-model="selectedLabel">
        <cube-tab-panel v-for="(item, index) in tabs" :index="index" :label="item.label" :key="item.label">
          <ul>
